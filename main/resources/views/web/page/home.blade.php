...
@section('content')
                ...
                <div class="about-body">
                    ...
                    <div class="row my-3 d-flex">
                        <div class="col-12 col-md-6 about-art mt-100">
                            ...
                            <p  
                            @if ($agent->isMobile()) 
                            style="font-size: 20px;max-width: 329px; line-height: 30px; margin-right: -15px"
                            @else
                            style="font-size: 20px;max-width: 329px; line-height: 30px;"
                            @endif>
    ...
    <section class="services section-p pt-5 pb-5" id="our_services"
        ...
        <div class="container">
            <div class="main-title d-flex justify-content-center align-items-center">
                <div class="jo-box-cont d-flex justify-content-center align-items-center w-auto">
                    <p class="m-0" @if ($agent->isMobile()) style="font-size: 20px;" @endif>{{ trans('frontend/home.home.services_section_title') }}</p>
                </div>
            </div>
            <p class="mt-4 fs-md-3 services__p" @if ($agent->isMobile()) style="font-size: 20px; font-weight: 500 text-align: right;" @endif>
        ...
        <div class="py-3">
            ...
            <div class="container">
                <div class="gallary-header head-p">
                    ...
                    <p class="mt-4 fs-md-3" @if ($agent->isMobile()) style="font-size: 20px; font-weight: 500 text-align: right;"@else style="font-size: 30px; text-align: center;"  @endif>
                        ...
                        <div class="container" style="padding-right: 10px; padding-left: 10px;">
                            <div class="head-p gallary-header gallary">
                                <div
                                    ...
                                    <div class="jo-box-cont d-flex justify-content-center align-items-center w-auto">
                                        <p style="margin:0;">{{ trans('frontend/home.home.package_section_title') }}</p </div>
                                    </div>
                        ...
                        <form id="contactForm" style="height: 100%; border: 1px solid #5c5b5b;" name="contactForm"
                            ...
                            <div class="row">
                                ...
                                <div class="pb-3 pt-3 col-12 col-md-6 text-end">
                                    ...
                                    <input type="text" placeholder="{{ __('frontend/home.home.full_name_placeholder') }}"
                            ...
                            <div class="pb-3 pt-3 text-end">
                                ...
                                <input type="email" autocomplete="email"
                                    placeholder="{{ __('frontend/home.home.email_placeholder') }}" class="form-control font-m"
                            ...
                            <div class="pb-3 pt-3 text-end">
                                ...
                                <select id="service" class="form-select text-light" name="service"
                                    ...
                                    <option value="صوتي و مرئي">{{ __('frontend/home.home.service_audio_visual') }}</option>
                            ...
                            <div class="pb-3 pt-3 text-end">
                                ...
                                <textarea placeholder="{{ __('frontend/home.home.details_placeholder') }}" class="form-control" id="msg" rows="5"
