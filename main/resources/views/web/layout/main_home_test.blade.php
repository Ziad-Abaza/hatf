                  ...
                  ? `
                        <div class="d-flex flex-column align-items-center">
                            <div class="position-relative w-100 image-container-icon-slider">
                                <img loading="lazy" src="${data.path}/${packageItem.image}" alt="Package 1" class="d-block w-100 card-img-top"
                        ...
                        <div class="d-flex flex-column align-items-center">
                            <div class="position-relative w-100">
                                ...
                                <div id="specialContent" class="aftar">
                                    <img loading="lazy" src="${data.path}/${packageItem.image}" alt="Package 1"
                                        class="d-block w-100">
                                </div>
                            </div>
