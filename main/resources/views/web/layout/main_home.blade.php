...
<html lang="ar" dir="rtl">
  <head>
    ...
    <meta
      ...
      content="io9rpttns7ztrjz273fs9q4dwk1g4b"
    />
    <meta
      name="google-site-verification"
      content="3Fg8fQvJVpe_y5VW_SoU2h44JxrZYkAxj6Fqy8xZM7M"
    />
    ...
    <!--  type="image/svg+xml"-->
    <!--/>-->
    <link rel="icon" href="{{asset('front/assets/imgs/favicon.svg')}}"          style { height: 24px; width: 24px;border-radius: 24px;}  type="image/x-icon">
    <link rel="shortcut icon" href="{{asset('front/assets/imgs/favicon.svg')}}" style { height: 24px; width: 24px;border-radius: 24px;}  type="image/x-icon">
    ...
    <link
      rel="stylesheet"
      href="{{ asset('front/assets/css/owl.theme.default.css') }}"
    />
    ...
    <script
      async
      src="https://www.googletagmanager.com/gtag/js?id=G-E8ZRMWHQRS"
    ></script>
    <script>
  ...
  <body data-bs-theme="dark">
    ...
    <noscript
      ><iframe
        src="https://www.googletagmanager.com/ns.html?id=GTM-PGW6ZSCB"
        height="0"
        width="0"
