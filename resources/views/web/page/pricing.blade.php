        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-4 ">
                <div class="project" style=" height: 400px;">
                    <img class="w-100 h-100 object-fit-fill py-3" src="../imgs/bigBrand.jpg" alt="">
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 ">
                <div class="project" style=" height: 400px;">
            ...
            <div class="col-12 col-md-6 col-lg-4 ">
                <div class="project" style=" height: 400px;">
                    <img class="w-100 h-100 object-fit-fill py-3" src="../imgs/brandSmall.jpg" alt="">
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 ">
                <div class="project" style=" height: 400px;">
