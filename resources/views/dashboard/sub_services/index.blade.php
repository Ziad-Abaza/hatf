...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-2"><span class="text-muted fw-light">لوحة التحكم /</span> خدمة فرعية</h4>

        <div class="col-lg-4 pb-4">
            <div class="demo-inline-spacing">
                <a href="{{ route('dashboard.sub_services.create') }}" class="btn btn-primary" style="color: #fff">
                    انشاء خدمة فرعية
                </a>
            </div>
        </div>
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($subServices as $subService)
                            <tr>
                                ...
                                <td>
                                    <span class="fw-medium">{{ Str::limit($subService->description , 12, '...') }}</span>
                                </td>
                                <td>
