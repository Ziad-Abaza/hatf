                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        value="{{ old('name', $review->name) }}" placeholder="أدخل اسم الشخص" />
                                </div>
                                @error('name')
                            ...
                            <div class="col-md-12 col-12 mb-3">
                                ...
                                <textarea name="content" id="content"
                                    ...
                                    placeholder="أضف محتوى المراجعة">{{ old('content', $review->content) }}</textarea>
                                @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="service_id" id="service_id"
                                        ...
                                        <option value="{{ $service->id }}" {{ old('service_id', $review->service_id) ==
                                            $service->id ? 'selected' : '' }}>
                                            {{ $service->name }}
                                        </option>
                                        @endforeach
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="rating" id="rating"
                                        ...
                                        @for ($i = 1; $i <= 5; $i++) <option value="{{ $i }}" {{ old('rating', $review->
                                            rating) == $i ? 'selected' : '' }}>
                                            ⭐ {{ $i }} / 5
                                            </option>
                                            @endfor
                            ...
                            <div class="col-md-12 col-12 mb-3">
                                ...
                                <div class="input-group gap-2">
                                    ...
                                    @if ($review->getFirstMediaUrl('reviews'))
                                    <div class="m-0">
                                        <img src="{{ $review->getFirstMediaUrl('reviews') }}" alt="Current Review Image"
