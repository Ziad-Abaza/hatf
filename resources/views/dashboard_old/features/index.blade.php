...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-2"><span class="text-muted fw-light">لوحة التحكم /</span> سمات</h4>

        <div class="col-lg-4 pb-4">
            <div class="demo-inline-spacing">
                <a href="{{ route('dashboard.features.create') }}" class="btn btn-primary" style="color: #fff">
                    انشاء سمة
                </a>
            </div>
        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($features as $feature)
                            <tr>
                                <td>
                                    <span class="fw-medium">{{ Str::limit($feature->title, 12, '...') }}</span>
                                </td>
                                <td>
                                    <span class="fw-medium">{{ Str::limit($feature->description, 12, '...') }}</span>
                                </td>
                                <td>
