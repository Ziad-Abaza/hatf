        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-12">
                    ...
                    <div class="card-body">
                        <form action="{{ route('dashboard.our-team.update', $ourTeam->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="name"
                                        class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $ourTeam->name) }}"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="job"
                                        class="form-control @error('job') is-invalid @enderror" value="{{ old('job', $ourTeam->job) }}"
