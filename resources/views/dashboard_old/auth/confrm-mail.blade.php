        ...
        <div class="authentication-inner row">
            ...
            <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <p class="mb-4">يرجى انشاء كلمة مرور للدخول الى حسابك وبدءالمغامرة</p>

                    <form id="formAuthentication" class="mb-3" action="{{ route('confrm-mail-post',['randCode'=>$randCode]) }}" method="POST">
                        @csrf
                        ...
                        <button class="btn btn-primary d-grid w-100">انشاء كلمة مرور</button>
                    </form>
                </div>
            </div>
            <!-- /Login -->
